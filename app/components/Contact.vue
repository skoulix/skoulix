        ...
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <dl class="mt-10 space-y-4 text-base/7 text-gray-600">
            ...
            <div class="flex gap-x-4">
              ...
              <dd>
                <a class="hover:" href="tel:+1 (555) 234-5678"
                  >+1 (555) 234-5678</a
                >
              </dd>
            </div>
            <div class="flex gap-x-4">
              ...
              <dd>
                <a class="hover:" href="mailto:hello@example.com"
                  >hello@example.com</a
                >
              </dd>
            </div>
      ...
      >
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              ...
              <div class="mt-2.5">
                <input
                  ...
                  class="block w-full rounded-md bg-white px-3.5 py-2 text-base outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
                />
              </div>
            </div>
            <div>
              <label for="last-name" class="block text-sm/6 font-semibold"
                >Last name</label
              >
              <div class="mt-2.5">
                <input
            ...
            <div class="sm:col-span-2">
              <label for="phone-number" class="block text-sm/6 font-semibold"
                >Phone number</label
              >
              <div class="mt-2.5">
                <input
